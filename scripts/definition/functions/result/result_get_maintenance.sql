drop function if exists result_get_maintenance;

create or replace function result_get_maintenance (
...
begin
    ...
    var_jsn_status = core_set_json_numeric (var_jsn_status, 'sys_result', 90);
    var_jsn_status = core_set_json_text (var_jsn_status, 'sys_message', 'Maintenance Mode');
