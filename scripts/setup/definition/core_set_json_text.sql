drop function if exists core_set_json_text;

create or replace function core_set_json_text (
...
begin
    ...
    var_jsn_object = json_build_object (in_txt_key, in_txt_value);
    ...
    begin
        ...
        var_jsn_object = var_txt_node :: jsonb || ('"' || in_txt_value || '"') :: jsonb;
